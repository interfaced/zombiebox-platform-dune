    ...
    <entry_point>
        ...
        <actions>
          <key_enter>
            ...
            <data>
               <url>www://http://localhost/plugins/<%=pluginDirName%>/index.html:::volume_handler=<%=enableVolumeOSD%>&amp;fullscreen=1&amp;webapp_keys=1&amp;zoom_level=100&amp;overscan=0&amp;osd_size=1280x720&amp;input_handler=0&amp;engine_flags=1&amp;background_color=black</url>
            </data>
          </key_enter>
        </actions>
